    ...
    *value++ = 0;
    ...
    if (!strcmp(name,"qemu")) {
        ...
        if (cnt < PROP_NAME_MAX)
            ...
            strlcpy(lcdtype, value, sizeof(lcdtype));
	}
}
...
static void export_kernel_boot_props(void)
{
    ...
    if (!strcmp(lcdtype,"ek070tn93"))
        property_set("ro.sf.lcd_density", "120");
    else if (!strcmp(lcdtype,"vs070cxn"))
        property_set("ro.sf.lcd_density", "160");
    else if (!strcmp(lcdtype,"vga-1024x768"))
        property_set("ro.sf.lcd_density", "160");
    else if (!strcmp(lcdtype,"vga-1440x900"))
        property_set("ro.sf.lcd_density", "200");
    else if (!strcmp(lcdtype,"vga-1280x1024"))
        property_set("ro.sf.lcd_density", "200");
    else
        property_set("ro.sf.lcd_density", "160");
}

...
//-----------------lenovo extend---------------------
    CAMERA_MSG_CHECK_LOSS_FOCUS = 0x01000,
    CAMERA_MSG_FPS_DETECTION = 0x02000,
    CAMERA_MSG_BLINK_DETECTION = 0x04000,
    CAMERA_MSG_CONTINOUS_SHOT = 0x08000,
    CAMERA_MSG_CHECK_LIGHT = 0x10000,
//--------------------------------------------------
    //add end by suojp 2012-04-11
    //add for burst shot by lzy 2013.5.13
    CAMERA_MSG_BURST_SHOT  = 0x20000,
    CAMERA_MSG_ALL_MSGS         = 0x7FFFFFFF    //modify by suojp 2012-04-11
};
...
//add begin by suojp 2012-04-11
//-----------------lenovo extend---------------------
    CAMERA_CMD_IGNORE_PREVIEW_WINDOW	= 11,
    CAMERA_CMD_START_CHECK_LOSS_FOCUS	= 12,
    CAMERA_CMD_STOP_CHECK_LOSS_FOCUS 	= 13,
    CAMERA_CMD_START_FPS_DETECTION	= 14,
    CAMERA_CMD_STOP_FPS_DETECTION 	= 15,
    CAMERA_CMD_START_BLINK_DETECTION	= 16,
    CAMERA_CMD_STOP_BLINK_DETECTION 	= 17,
    CAMERA_CMD_BREAK_CONTINOUS_SHOT	= 18,
    CAMERA_CMD_ENABLE_CONTINOUS_SHOT 	= 19,
    CAMERA_CMD_START_CHECK_PREVIEW_LIGHT = 20,
    CAMERA_CMD_STOP_CHECK_PREVIEW_LIGHT = 21,
//--------------------------------------------------
    //add end by suojp 2012-04-11
    //add for burst shot by lzy 2013.5.13
    CAMERA_CMD_BREAK_BURST_SHOT	= 22,
    CAMERA_CMD_ENABLE_BURST_SHOT 	= 23,
};
...
typedef struct camera_face {
    ...
    /**
     *add by wuqinghua for smile and blink feature 2012-05-04
      *
     */
    int32_t blink_level;
    int32_t smile_level;
...
#define DEF_SCALADO_MODE_FLAG	(0x8000) //add by suojp for scalado 2012-06-06
__END_DECLS
